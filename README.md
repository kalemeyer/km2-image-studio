...
- If background removal says `rembg` is missing, click **Install Background Removal** in the app. It runs `pip install rembg` for you and enables the feature once the install finishes.
